void MakePlots()
{
  ...
  c1->SaveAs("Plots/ShowerEnergy_TimeCuts_noSmearing.pdf");
  ...
  c2->SaveAs("Plots/ShowerWidth_TimeCuts_noSmearing.pdf");
  ...
  c11->SaveAs("Plots/RadialProfile_TimeCuts_noSmearing.pdf");
  ...
  c12->SaveAs("Plots/RadialProfileAbso_TimeCuts_noSmearing.pdf");
  ...
  c6->SaveAs("Plots/ShowerWidthAbso_TimeCuts_noSmearing.pdf");
  ...
  c3->SaveAs("Plots/ShowerReso_TimeCuts_noSmearing.pdf");
  ...
  c4->SaveAs("Plots/ShowerResoAbsolute_TimeCuts_noSmearing.pdf");
  ...
  c5->SaveAs("Plots/Linearity_TimeCuts_noSmearing.pdf");
  ...
  c10->SaveAs("Plots/ShowerWidth_Resolution_noSmearing.pdf");
  ...
  c9->SaveAs("Plots/HitEnergyHisto_TimeCuts_noSmearing.pdf");
  ...
  c99->SaveAs("Plots/HitEnergyHisto_50GeV_TimeCuts_noSmearing.pdf");
  ...
  c13->SaveAs("Plots/RadialProfileOverlay_noSmearing.pdf");
  ...
  c14->SaveAs("Plots/HitsRadialProfileOverlay_noSmearing.pdf");

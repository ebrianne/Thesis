...
In this analysis, the time calibration procedure of the AHCAL was presented. A time resolution in the order of 5 ns is achieved for a muon beam. Due to an electronic effect of widening of the time resolution with the number of triggered channels in a chip, a time resolution of 8 ns is achieved for electron and pion beams.

...
\begin{figure}[htbp!]
	...
	\end{subfigure}
	\caption{\subref{fig:RMS_Energy_Comparison}) The RMS of the time distribution as function of the hit energy for muons, electrons and pions in steel absorber taken in a range of -50 to 200 ns. The systematics are shown by the color bands. \subref{fig:RMS_SimData_50GeV}) Comparison between data and simulation of the RMS of the time distribution as a function of the hit energy. The color bands show the statistical and systematic uncertainty.}
\end{figure}

...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/EnergySum_100ns_30GeV.pdf}
    \caption{} \label{fig:Esum30_100ns}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/HitEnergySpectra_100ns_30GeV.pdf}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.7\linewidth]{chap6/fig_TimingILD/AdditionalPlots/HitEnergySpectra_Zoom_100ns_30GeV.pdf}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/CLim_100ns_10GeV.pdf}
    \caption{10 GeV.} \label{fig:CLim10_100ns}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/CLim_100ns_80GeV.pdf}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/EhcalCLimCav_100ns_10GeV.pdf}
    \caption{10 GeV.} \label{fig:EhcalCLimCav10_100ns}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/EhcalCLimCav_100ns_80GeV.pdf}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.7\linewidth]{chap6/fig_TimingILD/AdditionalPlots/CLimCav_100ns_SeveralEnergies.pdf}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.7\linewidth]{chap6/fig_TimingILD/AdditionalPlots/HitEnergySpectra_80GeV.pdf}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/EhcalCLimCav_1ns_10GeV.pdf}
    \caption{10 GeV.} \label{fig:EhcalCLimCav10_1ns}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/AdditionalPlots/EhcalCLimCav_1ns_80GeV.pdf}

...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/cluster_merge.png}
    \caption{Merging case.} \label{fig:asso_errors}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/cluster_split.png}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/photon_loss_para.png}
    \caption{Fitting of the probability of merging for photons.} \label{fig:proba_para}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/had_cha_dc_para.png}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[trim={0 18cm 0 3cm},clip, width=1\linewidth]{Appendixes/fig_SGV/FeymanDiagram/DiagWWqqqq.pdf}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/Comp_alltrk_Pandoratrk_toMC_wocurlers.png}
    \caption{$cos\theta$ distribution.} \label{fig:trk_para_mc_reco}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/eff_track_selection_wocurlers.png}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/Correlation_1.pdf}
    \caption{} \label{fig:jet_track_level_full}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/Correlation_2.pdf}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/dmin_charged_to_neutral_ECAL_all.pdf}
    \caption{ECAL case.} \label{fig:dmin_ECAL}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/dmin_charged_to_neutral_HCAL_all.pdf}
...
%   \begin{subfigure}[t]{0.45\textwidth}
%     \centering
%     \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/dmin_ECAL_2.pdf}
%     \caption{.} \label{fig:dmin_ECAL_noPFA}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{0.45\textwidth}
%     \centering
%     \includegraphics[width=1\linewidth]{Appendixes/fig_SGV/dmin_HCAL_2.pdf}

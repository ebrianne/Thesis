...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
    \raisebox{8ex}{\includegraphics[width=1\linewidth]{../Thesis_Plots/ILD/NoSmearing/Plots_Comparison/Comparison_resolution_Curves_Hits}}
...
For the resolution curves, one can see a rise of the resolution at high energies for the red, green and black lines certainly due to the non-linearity. The blue curve present a bump after 50 GeV changing suddenly the slope of the curve due to the over-correction of the energy.\\
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.5\textwidth}
    \centering
    \raisebox{8ex}{\includegraphics[width=1\linewidth]{../Thesis_Plots/ILD/NoSmearing/Plots_Comparison/Comparison_resolution_Curves_PFO}}
...
\begin{figure}[htbp!]
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=1\linewidth]{chap6/fig_TimingILD/NoSmearing/NumberEvents_PFO_TimeCuts_noSmearing}%To do
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.5\linewidth]{../Thesis_Plots/ILD/NoSmearing/Plots/ShowerReso_TimeCuts_noSmearing}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.5\linewidth]{../Thesis_Plots/ILD/NoSmearing/Plots/RadialProfileOverlay_noSmearing}
...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=0.5\linewidth]{../Thesis_Plots/ILD/TimeDistribution/Plots/ComparisonSmearingTimingAHCAL}
  \caption{.} \label{fig:SmearingAHCAL}
\end{figure}
